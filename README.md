...
This project is Open Source Hardware, so please feel free to build, modify, and test! To get started, see the Wiki for an overview of the hardware and available documents. To get involved, check out [How to Contribute](CONTRIBUTING.md).
